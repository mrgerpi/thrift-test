...
RequestTriggerReseponse::~RequestTriggerReseponse() throw() {
}


void RequestTriggerReseponse::__set_errorCode(const int32_t val) {
  this->errorCode = val;
}

void RequestTriggerReseponse::__set_reqponseJson(const std::string& val) {
  this->reqponseJson = val;
}

const char* RequestTriggerReseponse::ascii_fingerprint = "3F5FC93B338687BC7235B1AB103F47B3";
const uint8_t RequestTriggerReseponse::binary_fingerprint[16] = {0x3F,0x5F,0xC9,0x3B,0x33,0x86,0x87,0xBC,0x72,0x35,0xB1,0xAB,0x10,0x3F,0x47,0xB3};

uint32_t RequestTriggerReseponse::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t RequestTriggerReseponse::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  oprot->incrementRecursionDepth();
  xfer += oprot->writeStructBegin("RequestTriggerReseponse");
...
RequestTriggerReseponse::RequestTriggerReseponse(const RequestTriggerReseponse& other23) {
  errorCode = other23.errorCode;
  reqponseJson = other23.reqponseJson;
}
RequestTriggerReseponse& RequestTriggerReseponse::operator=(const RequestTriggerReseponse& other24) {
  errorCode = other24.errorCode;
  reqponseJson = other24.reqponseJson;
  return *this;
}
std::ostream& operator<<(std::ostream& out, const RequestTriggerReseponse& obj) {
  using apache::thrift::to_string;
  out << "RequestTriggerReseponse(";
  out << "errorCode=" << to_string(obj.errorCode);
